...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f,C2f_DCNv4, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3}:
        ...
        elif m in (CBAM, CrissCrossAttention,ResCCA,ResCCAv2, AgentAttention):
            c2 = ch[f]
            args=[c2,*args]
            if m in (ResCCA,ResCCAv2):
                if m is ResCCAv2:
                    args=[args[0]]
        else:
            c2 = ch[f]
